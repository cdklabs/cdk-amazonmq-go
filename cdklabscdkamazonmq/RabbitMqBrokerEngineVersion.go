...
func RabbitMqBrokerEngineVersion_V3_10_20() RabbitMqBrokerEngineVersion {
	_init_.Initialize()
	var returns RabbitMqBrokerEngineVersion
	_jsii_.StaticGet(
		"@cdklabs/cdk-amazonmq.RabbitMqBrokerEngineVersion",
...
func RabbitMqBrokerEngineVersion_V3_8_34() RabbitMqBrokerEngineVersion {
	_init_.Initialize()
	var returns RabbitMqBrokerEngineVersion
	_jsii_.StaticGet(
		"@cdklabs/cdk-amazonmq.RabbitMqBrokerEngineVersion",
...
func RabbitMqBrokerEngineVersion_V3_9_27() RabbitMqBrokerEngineVersion {
	_init_.Initialize()
	var returns RabbitMqBrokerEngineVersion
	_jsii_.StaticGet(
		"@cdklabs/cdk-amazonmq.RabbitMqBrokerEngineVersion",
